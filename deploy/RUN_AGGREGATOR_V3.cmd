...
title 4 KPP Aggregator FINAL FIXED v3.4
cd /d "%~dp0.."
set "ROOT=%CD%"
...
if not exist "%ROOT%\KPP\kpp_aggregator_v3.py" goto :bad_script

cd /d "%ROOT%\KPP"
if errorlevel 1 goto :bad_workdir

:restart
"%PY64%" -u "%ROOT%\KPP\kpp_aggregator_v3.py"
set "RC=%ERRORLEVEL%"
echo.
...
:bad_script
echo [FATAL] Script does not exist: %ROOT%\KPP\kpp_aggregator_v3.py
goto :fatal
