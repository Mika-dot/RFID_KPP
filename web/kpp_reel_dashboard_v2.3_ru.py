...
# -*- coding: utf-8 -*-
"""
RFID КПП • промышленный веб-мониторинг по KPP_ReelEvents.
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .title-block {
      background: linear-gradient(90deg, #17202b 0%, #263747 100%);
      color: #ffffff;
  ...
  <div class="page">
    <div class="header">
      <div class="title-block card">
        <h1 class="title">RFID КПП</h1>
        <div class="subtitle">
          Контроль движения катушек: RFID, видео, СКУД, 1С и Warehouse. Все итоговые и складские события фиксируются в <span class="mono">KPP_ReelEvents</span>.
        </div>
      </div>
      <div class="runtime">
    ...
    async function openEvent(eventId) {
      ...
      document.getElementById('modalBody').innerHTML = `
        <div>
          ...
          <div class="detail-card" style="margin-bottom:16px;">
            <div class="detail-title">Склад / Warehouse</div>
            <div class="detail-grid">
              <div class="detail-item"><small>Склад найден</small><span>${data.WarehouseId ? 'Да' : 'Нет'}</span></div>
              <div class="detail-item"><small>ID Warehouse</small><span>${data.WarehouseId || '—'}</span></div>
              ...
              <div class="detail-item"><small>Серия склада</small><span>${escapeHtml(data.WarehouseSeriesNumber || '—')}</span></div>
              <div class="detail-item"><small>Тип склада</small><span>${escapeHtml(data.WarehouseMatchType || '—')}</span></div>
            </div>
          </div>
...
if __name__ == "__main__":
    print("\n" + "█" * 100)
    print("🌐 RFID КПП • WEB v2.3 по KPP_ReelEvents")
    print("█" * 100)
